...
- name: AWS Elastic Load Balancing API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-elastic-load-balancing/master/_listings/aws-elastic-load-balancing/action-setsubnets-get.md
x-common:
